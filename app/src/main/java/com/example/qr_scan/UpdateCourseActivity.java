...
import androidx.appcompat.app.AppCompatActivity;
    ...
    public class UpdateCourseActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            dbHandler = new MyDBHandler(UpdateCourseActivity.this);
            ...
            updateCourseBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(UpdateCourseActivity.this, "Details Updated..", Toast.LENGTH_SHORT).show();

                    // launching our view activity.
                    Intent i = new Intent(UpdateCourseActivity.this, ViewStudent.class);
                    startActivity(i);
                }
            });
        }
